...
const FilterTop = ({filterAll, searched, active, setActive}) => {
  ...
  return (
    <div className='my-14 mt-24 flex-center w-full sm:my-10 sm:block sm:space-y-3 sm:mb-0'>
        ...
        <h4 onClick={()=>navigate('/')} className="text-lg font-semibold sm:mx-3 text-[#BCB7B7] lg:hidden med:hidden">Home / Marketplace /<span className='text-black font-semibold'> Editorials</span></h4>
