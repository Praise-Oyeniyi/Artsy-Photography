...
const Creators = () => {
  return (
    <div className="top-creators-outer w-full bg-[#e2e2e2] py-10 header-main">
        <div className="top-creators w-5/6 mx-auto space-y-10">
          <div className="w-full top-creators-top flex justify-between items-start">
            <h3 className='text-55 font-semibold w-3/6 leading-tight '>TOP CREATORS OF THE WEEK</h3>
          ...
          <div className="top-creators-bottom flex flex-col relative my-96 space-y-3">
            <div className="top-creators-image absolute w-4/6 -top-28 right-12">
              <div className='mx-auto relative z-30 animate-[changeBg_10s_ease-in-out_infinite] !bg-no-repeat creator-animate h-[35rem]'></div>
            </div>

            <p className='text-32 pr-16 text-gray-600 font-thin relative tracking-wide z-10 leading-normal'>
            ...
            <h3 className='text-48 font-extrabold absolute right-44 top-10 z-[99]'>
              CIRCA
            </h3>
            <h2 className='w-[92%] relative -top-20 text-right line-through font-extrabold text-9xl z-[99]'>
              1985
            </h2>
          </div>
        </div>
